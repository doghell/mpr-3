...
static void testCreateEvent(MprTestGroup *gp)
{
    ...
    event = mprCreateEvent(mprGetDispatcher(gp), eventCallback, 50, 0, (void*) gp, 0);
...
static void testCancelEvent(MprTestGroup *gp)
{
    ...
    event = mprCreateEvent(mprGetDispatcher(gp), eventCallback, 20000, 0, (void*) gp, 0);
    assert(event != 0);
...
static void testReschedEvent(MprTestGroup *gp)
{
    ...
    event = mprCreateEvent(mprGetDispatcher(gp), eventCallback, 50000000, 0, (void*) gp, 0);
    assert(event != 0);
